...
/**
 * push_error - handle different errors that may come up
...
/**
 * pop_error - handle different errors that may come up
...
/**
 * read_error - handle different errors that may come up
 * @tokens: command split by whitespalce
 * @stack: stack/queue data structure
 * @line_number: current line number
 * Return: int, EXIT_FAILURE, EXIT_SUCCESS
...
/**
 * math_error - handle different errors that may come up
 * @tokens: command split by whitespalce
 * @stack: stack/queue data structure
 * @line_number: current line number
 * Return: int, EXIT_FAILURE, EXIT_SUCCESS
